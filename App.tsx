...
function App() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${isDark ? 'bg-[#050505] text-white' : 'bg-[#f8fafc] text-zinc-800'} font-sans overflow-x-hidden`}>
      {/* Sidebar - Desktop */}
      ...
      <div className="flex-1 lg:ml-72 flex flex-col min-h-screen relative">
        ...
        {/* Top Header */}
        <header className="border-b border-zinc-200 dark:border-zinc-800 sticky top-0 z-20 px-8 h-24 flex items-center justify-between bg-white/80 dark:bg-[#050505]/80 backdrop-blur-sm shadow-sm transition-colors duration-300">
        ...
        {/* Dashboard Content */}
        <main className="flex-grow p-8 sm:p-12 w-full relative z-10 transition-colors duration-300">
          {renderCalculator()}
        </main>
      </div>
    </div>
