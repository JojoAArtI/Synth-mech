...
export const Sidebar: React.FC<SidebarProps> = ({ currentMode, onModeChange }) => {
  ...
  return (
    <aside className="w-72 bg-white dark:bg-[#0a0a0a] border-r border-zinc-200 dark:border-zinc-800 hidden lg:flex flex-col fixed inset-y-0 left-0 z-30 shadow-[4px_0_24px_-12px_rgba(0,0,0,0.1)] transition-colors duration-300">
      {/* Brand Header */}
