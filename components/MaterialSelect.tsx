...
export const MaterialSelect: React.FC<MaterialSelectProps> = ({
  ...
  return (
    <div className="relative group">
       ...
       {/* Main Selection Area */}
       <div className="bg-white dark:bg-[#0a0a0a] border border-zinc-200 dark:border-zinc-800 p-1 rounded-sm relative hover:border-zinc-400 dark:hover:border-zinc-600 transition-colors shadow-sm">
          <select
            value={selectedId}
