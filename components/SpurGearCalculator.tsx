...
export const SpurGearCalculator: React.FC = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
       if (state.power > 0 && state.speedPinion > 0 && state.teethPinion > 0) {
         calculate();
       }
    }, 500);
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-full animate-in fade-in duration-700">
      ...
      <div className="lg:col-span-7 space-y-12">
        ...
        <div className="relative border-l border-zinc-300 dark:border-zinc-800 pl-8 ml-4 transition-colors">
           {/* Decorative Marker */}
        ...
        {/* Section 03: Geometry */}
        <div className="relative border-l border-zinc-300 dark:border-zinc-800 pl-8 ml-4 pb-4 transition-colors">
           <div className="absolute -left-1.5 top-0 w-3 h-3 bg-white dark:bg-black border border-black dark:border-zinc-600 rotate-45 transition-colors" />
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="flex flex-col group">
                 ...
                 <select value={state.toothSystem} onChange={(e) => updateState('toothSystem', parseInt(e.target.value))} className="w-full bg-white dark:bg-[#0a0a0a] border border-zinc-200 dark:border-zinc-800 text-black dark:text-zinc-100 font-mono text-sm py-3 px-3 rounded-sm focus:border-black dark:focus:border-white appearance-none shadow-sm transition-colors">
